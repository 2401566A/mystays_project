...
urlpatterns = [
    ...
    path('WhereToStay/SortByRating/', views.SortStaysByRatingView.as_view(), name='sorted_by_rating'),
    path('WhereToStay/SortByPriceValue/', views.SortStaysByPriceValueView.as_view(), name='sorted_by_price'),
    path('WhereToStay/SortByLocationValue/', views.SortStaysByLocationValueView.as_view(), name='sorted_by_location'),
